...
`ifdef SIMULATION
    initial begin
        ...
        register_file[11] = 32'h80000000;
        register_file[12] = 32'h00000001;
        register_file[13] = 32'h00000003;
        register_file[14] = 32'h00000021;
        //register_file[12] = 32'h80000003;
        //register_file[13] = 32'h00000021;
        //register_file[14] = 32'h80000003;
        //register_file[15] = 32'h80000000;
        //register_file[16] = 32'h00000001;
        //register_file[16] = 32'h00000001;
        for (int i = 15; i < 32; i++) begin
            register_file[i] = i;
        end
